...
if($_POST["submit"]) {
    ...
    $subject="Customer From Submission - Metallic Page";
    $sender=$_POST["sender"];
  ...
  <main class="hoc container clear">
    ...
    <div class="sidebar one_third first">
      ...
      <nav class="sdb_holder">
        <ul>
          <li><a href="/pages/decorativeship.php">Decorative Chip</a>
          <li><a href="/pages/medici.php">Medici</a></li>
          <li><a href="#">Metallic</a></li>
    ...
    <style>
      ...
      <!--<img class="imgr borderedbox inspace-5" src="../images/demo/imgr.gif" alt="">-->
        ...
        <img class="mySlides" src="../images/gFloors/PM.jpg" style="width:100%">
        <img class="mySlides" src="../images/gFloors/PM2.jpg" style="width:89%">
        <img class="mySlides" src="../images/gFloors/PM3.jpeg" style="width:89%">
        <img class="mySlides" src="../images/gFloors/PM4.jpg" style="width:89%">
        ...
        <p>Metallic flooring is an extremely durable, high-end flooring which uses metallic powder tints.</p>

        <p>We are able to produce beautiful one-of-a-kind floor coatings that contain pearlescent and iridescent accents with amazing high shine finishes. These types of floor coatings are the newest rave for both commercial applications and retail environments. They are an ideal choice for any residential customers looking for the “next big thing” that will set their home apart from others.</p>

        <p>With the entire coating system able to be installed in as little as one day, the variety of uses and return to service times are unmatched by any other company in the market offering a similar product. This coating system can replace tiles, laminates, and wood flooring in high-end apartments and condos, hotels and restaurants, hospitals and offices, as well as just about any application you can dream up. The uses for this revolutionary coating system are truly endless.</p>

        <p>Metallic Floor Coatings are available in a wide variety of colors to fit any customer’s needs and wants. There is also an option to use multiple colors in order to create “marble-like” finishes and “chameleon” color changing textures. Below are just a few of the colors that are available exclusively through Citadel Floor Finishing Systems.</p>
        <img src="../images/gFloors/MettalicGraphic.png" alt="display this" style="height:300px;">
        <h2>Sample Colors</h2>
        <p>Below you can see some available colors for our Mettalic floors. Call or fill out the 'get a quote' form below for more colors and information.</p>
        <img src="../images/gFloors/MettalicColors.png" alt="Broadcast Chip Colors and Sizes" style="height:600px;">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/mvSpSDJmv3k" frameborder="0" allowfullscreen></iframe>
...
<div class="wrapper row4">
  <footer id="footer" class="hoc clear">
    ...
    <div class="one_third">
      ...
      <form method="post" action="/pages/metallic.php">
        <fieldset>
