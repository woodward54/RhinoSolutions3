...
if($_POST["submit"]) {
    ...
    $subject="Customer From Submission - Medici Page";
    $sender=$_POST["sender"];
  ...
  <main class="hoc container clear">
    ...
    <style>
      ...
      <!--<img class="imgr borderedbox inspace-5" src="../images/demo/imgr.gif" alt="">-->
        <div class="w3-content w3-display-container w3-center" style="width:100%">
        <img class="mySlides dw-center" src="../images/gFloors/M5.jpg" style="width:80%">
        <img class="mySlides" src="../images/gFloors/M3.jpg" style="width:100%">
        <img class="mySlides dw-center" src="../images/gFloors/M4.jpg" style="width:90%">
        <img class="mySlides dw-center" src="../images/gFloors/M2.jpg" style="width:72%">
        ...
        <p>With the Medici Polyurea color Coating System you can create a wide variety of decorative finishes that will outlast any other acrylic or acid stain system currently available.</p>

        <p>Unique floors are quickly installed using Dualie Roller™, and the results are as beautiful as they are strong. Custom texturing is possible via sponge rollers and foam brushes, while the virtually unlimited pot-life of the material allows plenty of time to create the desired look. With endless color combinations available, the installer is truly unlimited in their design and artistic finish. The high solids content and excellent abrasion resistance of the Polyurea-1 HD make it the optimal choice for all applications.</p>

        <p>With polyone HD single component Aliphatic Polyurea’s chemical makeup, this product has a virtually unlimited pot-life allowing the installer adequate time to create one-of-a-kind textures and finishes. With 100% UV-Stability, the Medici™ System is able to be installed outdoors or in direct sunlight without any yellowing, chalking, or fading over time. Combine that with its high chemical resistance, low odour, ease of use, and extreme abrasion resistance and it is no wonder why it is hottest coating system available today. No other coatings manufacturers have anything like this –the only way to get this look was to use acid stains, sprays, and dyes that are time consuming to install and don’t hold up to heavy traffic. The Medici™ System will be the optimal choice for basement floors, patios, offices, pool surrounds, and any other location needing that old world, mottled, natural finish and texture.</p>



        <img src="../images/gFloors/MediciGraphic.png" alt="display this" style="height:300px;">
        <h2>Sample Colors</h2>
        <p>Below you can see some available colors for our Medici floors. Call or fill out the 'get a quote' form below for more colors and information.</p>
        <img src="../images/gFloors/MediciColors.png" alt="Broadcast Chip Colors and Sizes" style="height:400px;">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/mHnvKsP4RNE" frameborder="0" allowfullscreen></iframe>
...
<div class="wrapper row4">
  <footer id="footer" class="hoc clear">
    ...
    <div class="one_third">
      ...
      <form method="post" action="/pages/medici.php">
        <fieldset>
