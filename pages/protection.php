...
if($_POST["submit"]) {
    ...
    $subject="Customer From Submission - Protection Page";
    $sender=$_POST["sender"];
...
<div class="wrapper row2">
  <nav id="mainav" class="hoc clear">
    ...
    <ul class="clear">
      ...
      <li><a href="#">Construction Protection</a></li>
  ...
  <main class="hoc container clear">
    ...
    <div class="content">
      ...
      <ul style="margin-top: -0.7em;">
        ...
        <li> Protecive Carpet Covering</li>
        <li> Protective Cover on Counter Tops</li>
        <li> Protective Cover on Cabinets</li>
        <li> Install Dust Containment Protection</li>
        <li> Call for Additional Services</li>
      </ul>

      <h2>Attic Decking and Trim out</h2>
      <p style="float: left; font-size: 12pt; text-align: center; width: 48%; margin-top: -.7em; margin-right: 1%; margin-bottom: 0.7em;">Before</p>
      <p style="float: left; font-size: 12pt; text-align: center; width: 48%; margin-top: -.7em; margin-bottom: 0.7em;">After</p>
      <img src="../images/protection/IMG_4704.JPG" style="float: left; width: 48%; height: auto; margin-right: 1%; margin-bottom: 10px;">
      <img src="../images/protection/IMG_4705.JPG" style="float: left; width: 48%; height: auto; margin-bottom: 10px;">

      <img src="../images/protection/IMG_4912.JPG" style="float: left; width: 48%; height: auto; margin-right: 1%; margin-bottom: 10px;">
      <img src="../images/protection/IMG_4913.JPG" style="float: left; width: 48%; height: auto; margin-bottom: 10px;">

      <img src="../images/protection/IMG_4020.JPG" style="float: left; width: 48%; margin-right: 1%; margin-bottom: 10px;">
      <img src="../images/protection/IMG_4019.JPG" style="float: left; width: 48%; margin-bottom: 20px;">
      ...
      <h1>Protective Floor Coverings</h1>
      <img src="../images/protection/IMG_2069.JPG" style="float: left; width: 32%; margin-right: 1%; margin-bottom: 1.5em;">
      <img src="../images/protection/IMG_6805.JPG" style="float: left; width: 32%; margin-right: 1%; margin-bottom: 1.5em;">
      <img src="../images/protection/IMG_4508.JPG" style="float: left; width: 32%; margin-right: 1%; margin-bottom: 1.5em;">
      <!--<img src="../images/protection/IMG_2701.JPG" style="float: left; width: 100%; margin-bottom: 0.25em;">-->
      <p style="clear: both;">


      <h1>Protective Covers on Counter Tops and Cabinets</h1>
      <div class="w3-content w3-display-container w3-center" style="width:70%">
      <img class="mySlides" src="../images/protection/IMG_2902.jpg" style="width:100%">
      <img class="mySlides" src="../images/protection/IMG_4339.jpg" style="width:100%">
      <img class="mySlides" src="../images/protection/IMG_4343.jpg" style="width:100%">
...
<div class="wrapper row4">
  <footer id="footer" class="hoc clear">
    ...
    <div class="one_third">
      ...
      <form method="post" action="/pages/protection.php">
        <fieldset>
