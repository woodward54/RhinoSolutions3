  ...
  <main class="hoc container clear">
    ...
    <style>
      ...
      <div class="w3-content w3-display-container w3-center" style="width:95%">
        <img class="mySlides dw-center" src="../images/gMakeover/render2.jpeg" style="width:95%">
        ...
        <img class="mySlides dw-center" src="../images/gMakeover/render1.jpeg" style="width:95%">
